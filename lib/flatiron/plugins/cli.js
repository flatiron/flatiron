...
exports.attach = function (options) {
  ...
  // and exit.
  //
  if (options.version && app.version && (this.argv.v || this.argv.version)) {
...
exports.commands = function (options) {
  ...
  app.cli.source = options.dir || options.source;
    ...
    if (app.cli.source) {
      ...
      try {
        if (app.cli.sourceDir) {
          ...
          app.commands = utile.mixin(app.commands, require(app.cli.source));
        }
        return true;
      }
      catch (err) {
  ...
  app.alias = function (target, source) {
    app.commands.__defineGetter__(target, function () {
      var target = source.resource || source.command || source,
          resource;
          
      loadCommand(target, true);
      resource = app.commands[target];
