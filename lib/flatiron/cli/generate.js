      ...
      switch(arguments[0]) {
        ...
        case 'helper':
          if (arguments.length > 1) {
            ...
            files.push({
              src: 'helper.js',
              conf: {name: name},
              path: path.join(target.helpers, name + '.js')
            });
          } else {
            module.exports.writeHelp(arguments[0]);
          }
        ...
        case 'presenter':
          if (arguments.length > 1) {
            ...
            files.push({
              src: 'presenter.js',
              conf: {name: name, actions: actions.join(',\n\n')},
...
module.exports.help['api'] = [
  'Creates REST api for the given resource. Pass the resource',
  'name and a list of properties',
  '',
  'generate api <name>',
  '',
  'Example: `flatiron generate api Post name content`',
  '',
...
module.exports.help['helper'] = [
  'Creates a helper in the application. Pass the helper name,',
  'either CamelCase or under_scored.',
  '',
  'generate helper <name>',
  '',
  'Example: `flatiron generate helper gravatar`',
  '',
  '  Helper: app/helpers/gravatar.js'
];
...
module.exports.help['presenter'] = [
  ...
  '',
  '  Presenter: app/presenters/credit_card.js',
  '  Views:     app/views/credit_card/open.html [...]',
];
...
module.exports.help['scaffold'] = [
  ...
  '  Presenter:  app/presenters/posts.js',
  '  Resource:   app/resource/post.js',
  '  Views:      app/views/posts/index.html [new, create, show, edit, update, destroy]',
];
