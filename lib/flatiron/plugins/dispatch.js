...
exports._routesBuilder = function (scope) {
  ...
  this.root = function (action) {
    ...
    if (exports._checkAction(action)) {
      this._scope['/'] = exports._allMethods(app.presenters[action[0]][action[1]]);
    }
  };
  ...
  this.match = function (url, action) {
    action = action.split('/');
    if (exports._checkAction(action)) {
      this._scope['/' + url] = exports._allMethods(app.presenters[action[0]][action[1]]);
    }
  };
...
exports._allMethods = function (func) {
  return {
    get: func,
    post: func,
    put: func,
