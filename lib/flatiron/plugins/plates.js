...
exports.attach = function (options) {
  ...
  app.view = function (view, data, options) {
    ...
    var html = exports.readFileSync(path.join(exports._platesDir, view + exports._extname));

    if (layout) {
      var layoutFile = exports.readFileSync(path.join(exports._layoutsDir, layout + exports._extname));
      html = plates.bind(layoutFile, { body: html });
    }
